// GTA V ванильные транспортные средства
// Данные из vehicles_hashes.txt с категориями

export interface GTAVVehicle {
  name: string
  displayName: string
  hash: number
  category: string // Теперь это строка с реальной категорией
  isGTAV: true
}
...
/**
 * Получить список GTA V транспортных средств
 */
